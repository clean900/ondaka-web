...
<body>
    ...
    <div class="cabecalho">
        ...
        <div class="sub">
            ...
            <br>Gerado em {{ $dataGeracao }}
        </div>
    </div>

    <div class="seccao">
        <h2>Receitas vs Despesas (12 meses)</h2>
    ...
    <div class="seccao">
        ...
        @if(count($cobranca['devedores']))
        <table style="margin-top:10px;">
            <tr><th>Top devedores</th><th class="num">Dívida</th></tr>
    ...
    <div class="seccao">
        ...
        @else
        <p style="color:#999;">Sem despesas pagas.</p>
        @endif
    </div>
    ...
    <div class="rodape">
        ONDAKA &middot; {{ $empresa->nome ?? '' }} @if(!empty($empresa->nif)) &middot; NIF {{ $empresa->nif }} @endif &middot; Documento gerado automaticamente
    </div>
</body>
</html>
