@component('emails.condomino._layout', ['badge' => 'MULTA', 'tituloHero' => 'Multa aplicada'])
<p style="margin:0 0 16px; font-size:16px; color:#fff;"><strong>Caro(a) {{ $nome }},</strong></p>
<p style="margin:0 0 16px;">Foi aplicada uma multa à sua conta de condomínio.</p>
<table width="100%" cellpadding="0" cellspacing="0" style="background:#0f0f1f; border-radius:8px; margin:20px 0;">
<tr><td style="padding:20px;">
<div style="font-size:13px; color:#888;">Valor da multa</div>
<div style="font-size:28px; font-weight:bold; color:#ec4899; margin:4px 0;">{{ $valor }} Kz</div>
<div style="font-size:13px; color:#888; margin-top:12px;">{{ $motivo }}</div>
<div style="font-size:13px; color:#888; margin-top:8px;">Vence a <strong style="color:#e5e5e5;">{{ $vencimento }}</strong></div>
</td></tr>
</table>
<p style="margin:0 0 16px;">Regularize o pagamento para evitar acréscimos.</p>
