@component('emails.condomino._layout', ['badge' => 'ENCOMENDA', 'tituloHero' => 'Encomenda na portaria'])
<p style="margin:0 0 16px; font-size:16px; color:#fff;"><strong>Caro(a) {{ $nome }},</strong></p>
<p style="margin:0 0 16px;">Chegou uma encomenda para si. Pode levantá-la na portaria.</p>
...
<div style="font-size:13px; color:#888; margin-top:12px;">Local: <strong style="color:#e5e5e5;">Portaria</strong></div>
</td></tr>
</table>
