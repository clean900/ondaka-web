...
<head>
    ...
    <title>500 — Erro no servidor | ONDAKA</title>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="titulo">Erro no servidor</div>
            <div class="descricao">Ocorreu um erro inesperado. Já estamos a tratar disso — tente novamente dentro de momentos.</div>
