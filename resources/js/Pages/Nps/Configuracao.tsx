...
export default function NpsConfiguracao({ config }: Props) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Configurar NPS — Condomínio" />
            <div className="max-w-2xl mx-auto px-4 py-6">
                <h1 className="text-xl font-medium text-white mb-1">Configurar NPS do Condomínio</h1>
                <p className="text-sm text-white/60 mb-6">
                    Define como e com que frequência os condóminos avaliam a gestão do condomínio.
                </p>
                ...
                <div className="space-y-5">
                    <label className="flex items-center justify-between p-4 rounded-xl bg-white/[0.03] border border-white/10">
                        <div>
                            ...
                            <p className="text-xs text-white/50">Se desligado, não se pede avaliação aos condóminos.</p>
                        </div>
                        <input
                            type="checkbox"
                            checked={data.activo}
