                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                            ...
                            >
                                ...
                                <div className="leading-tight">
                                    <div className="text-[10px] uppercase tracking-wide text-white/50">Disponível no</div>
                            ...
                            >
                                ...
                                <div className="leading-tight">
                                    <div className="text-[10px] uppercase tracking-wide text-white/50">Descarregar na</div>
