...
export default function Contratos({ titulo, descricao }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={titulo} />
            ...
            <div className="max-w-4xl mx-auto py-8">
                ...
                <div className="rounded-2xl border border-zinc-700/50 bg-zinc-900/50 p-12 text-center">
                    ...
                    <p className="text-sm text-zinc-400 max-w-md mx-auto">
                        Esta secção vai permitir gerir contratos do condomínio (administração, serviços, fornecedores) com versionamento e assinatura digital.
                    </p>
                </div>
            </div>
        </AuthenticatedLayout>
