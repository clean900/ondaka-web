...
class DespesaController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $query = Despesa::query()
            ->with(['categoria:id,nome,cor,icone', 'condominio:id,nome,exige_aprovacao_comissao', 'contaBancaria:id,nome,banco', 'criadaPor:id,name', 'aprovadaPor:id,name', 'pagaPor:id,name'])
