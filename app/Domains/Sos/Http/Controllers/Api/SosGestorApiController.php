...
class SosGestorApiController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        if (! $empresaId) {
            return response()->json(['data' => [], 'message' => 'Sem empresa associada.']);
        }
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        $empresaId = $user->empresa_gestora_id;
        $alerta = SosAlerta::with(['fotos', 'condominio:id,nome,empresa_gestora_id', 'user:id,name', 'atendidoPor:id,name'])
            ->find($id);

        if (! $alerta || $alerta->condominio?->empresa_gestora_id !== $empresaId) {
    ...
    public function atualizarEstado(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json([
            'data' => ['id' => $alerta->id, 'estado' => $alerta->fresh()->estado],
