...
import { A as AuthenticatedLayout, a as formatKz, g as gradientDeNome, i as iniciais, b as formatRelativo } from "./AuthenticatedLayout-TDdsYzgz.js";
import { usePage, Head, Link } from "@inertiajs/react";
import { Sparkles, Plus, Building2, Users, Receipt, TrendingUp, ArrowUpRight, ChevronRight, AlertCircle } from "lucide-react";
...
function Dashboard({ dados }) {
  ...
  const receitaMensal = (dados == null ? void 0 : dados.receita_mensal) ?? [];
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 card-elevated", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "h-48 -mx-2", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: receitaMensal, margin: { top: 5, right: 10, left: 10, bottom: 0 }, children: [
          /* @__PURE__ */ jsxs("defs", { children: [
            /* @__PURE__ */ jsxs("linearGradient", { id: "colorReceita", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "#00D4FF", stopOpacity: 0.3 }),
              /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "#A855F7", stopOpacity: 0 })
            ] }),
            /* @__PURE__ */ jsxs("linearGradient", { id: "colorLinha", x1: "0", y1: "0", x2: "1", y2: "0", children: [
          ...
          /* @__PURE__ */ jsx(
            Tooltip,
            {
              ...
              formatter: (v) => [formatKz(v), "Receita"]
            }
          ),
          /* @__PURE__ */ jsx(
            Area,
