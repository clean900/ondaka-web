...
import { AlertCircle, AlertTriangle, Clock, MessageCircle, Bot, X, User, Send, Building2, Settings, UserPlus, KeyRound, Receipt, CreditCard, Wallet, FileText, Bell, MessageSquare, Calendar, Wrench, Users, GraduationCap, Search, ChevronRight, CheckCheck, LayoutDashboard, UserCog, Siren, DoorOpen, Package, Ticket, Tag, Briefcase, LifeBuoy, FileBarChart, Shield, DollarSign, Sparkles, Menu, Map, LogOut } from "lucide-react";
  ...
  const seccoes = [
    ...
    },
    {
      ...
      itens: [
        ...
        { label: "Assembleias", href: "/assembleias", icon: Users },
        ...
        { label: "Empresas Prestadoras", href: "/configuracoes/empresas-prestadoras", icon: Briefcase },
        { label: "Contactos & Suporte", href: "/configuracoes/contactos-suporte", icon: LifeBuoy },
        { label: "Modelos de Turno", href: "/configuracoes/turnos", icon: Clock },
        { label: "Escala de Turnos", href: "/turnos/escala", icon: Calendar },
        { label: "Marcar Presença", href: "/turnos/presenca", icon: Clock },
        { label: "Relatório de Horas", href: "/turnos/relatorio", icon: FileBarChart },
        { label: "FAQs do Chatbot", href: "/admin/chatbot/faqs", icon: MessageSquare },
        { label: "Documentos", href: "#", icon: FileText, disabled: true, badge: "Em breve" },
        { label: "Segurança", href: "#", icon: Shield, disabled: true, badge: "Em breve" }
      ]
    },
    {
      titulo: "Facturação",
      ...
      "aside",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("nav", { className: "px-3 py-5 space-y-6 overflow-y-auto", style: { maxHeight: "calc(100vh - 160px)" }, children: seccoes.map((seccao) => /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "px-3 mb-2 text-[10px] text-white/40 uppercase tracking-[1.5px] font-semibold", children: seccao.titulo }),
            /* @__PURE__ */ jsx("div", { className: "space-y-0.5", children: seccao.itens.map((item) => {
