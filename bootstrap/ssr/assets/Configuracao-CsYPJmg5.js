...
import "remark-gfm";
import "driver.js";
function NpsConfiguracao({ config }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post("/nps/configuracao", { preserveScroll: true });
  };
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Configurar NPS — Condomínio" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto px-4 py-6", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-xl font-medium text-white mb-1", children: "Configurar NPS do Condomínio" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-white/60 mb-6", children: "Define como e com que frequência os condóminos avaliam a gestão do condomínio." }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("label", { className: "flex items-center justify-between p-4 rounded-xl bg-white/[0.03] border border-white/10", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-white/50", children: "Se desligado, não se pede avaliação aos condóminos." })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
