...
function AdminFeaturesNova({ features, empresas, condominios, condominos }) {
  const form = useForm({
    tipo_owner: "empresa",
    owner_id: "",
    feature_id: "",
  ...
  const owners = form.data.tipo_owner === "empresa" ? empresas : form.data.tipo_owner === "user" ? condominos : condominios;
  const submit = (e) => {
    e.preventDefault();
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto space-y-6 pt-2", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-white/[0.03] border border-white/10", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-2", children: ["empresa", "condominio", "user"].map((tipo) => /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "font-medium", children: tipo === "empresa" ? "Empresa gestora" : tipo === "user" ? "Condómino" : "Condomínio" })
            },
            tipo
          )) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-white/[0.03] border border-white/10", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm text-white/80 mb-2", children: form.data.tipo_owner === "empresa" ? "Empresa" : form.data.tipo_owner === "user" ? "Condómino" : "Condomínio" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              children: [
                ...
                owners.map((o) => /* @__PURE__ */ jsxs("option", { value: o.id, children: [
                  ...
                  "condominio_nome" in o && o.condominio_nome ? ` — ${o.condominio_nome}` : ""
                ] }, o.id))
              ]
            }
          ),
