          ...
          tab === "quotas" && /* @__PURE__ */ jsxs("form", { onSubmit: submitQuotas, className: "bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "border-t border-zinc-800 pt-4 mt-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "border-t border-zinc-800 pt-4 mt-4", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-white mb-1", children: "Transparência financeira" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-zinc-400 mb-3", children: 'Quando activo, os condóminos vêem no app o resumo financeiro do condomínio (receitas/despesas, fundo de reserva, cobrança e despesas por categoria — sem nomes de devedores) no ecrã "Contas do Condomínio".' }),
                /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [
                  /* @__PURE__ */ jsx("input", { type: "checkbox", checked: quotasForm.data.transparencia_financeira, onChange: (e) => quotasForm.setData("transparencia_financeira", e.target.checked), className: "rounded bg-zinc-700 border-zinc-600 text-cyan-500" }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm text-white", children: "Publicar transparência financeira aos condóminos" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "border-t border-zinc-800 pt-4 mt-4", children: [
