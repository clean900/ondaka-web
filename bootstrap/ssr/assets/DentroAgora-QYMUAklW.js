...
import { DoorOpen, Clock, Users, User, Home, Key, Package, AlertTriangle, Plus } from "lucide-react";
import "sonner";
import "clsx";
...
function DentroAgora({ visitas, total, controloBensActivo }) {
...
function ItensVisita({ visita }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-3 ml-13 rounded-lg border border-zinc-800 bg-zinc-950/40 p-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-xs font-medium text-zinc-400", children: [
    ...
    itens.length > 0 && /* @__PURE__ */ jsx("ul", { className: "space-y-1.5 mb-2", children: itens.map((item) => /* @__PURE__ */ jsxs("li", { className: "flex items-center justify-between gap-2 text-sm", children: [
      ...
      ] }) : /* @__PURE__ */ jsx("span", { className: `px-2 py-0.5 rounded text-xs font-medium flex-shrink-0 ${ESTADO_BADGE[item.estado]}`, children: item.estado === "saiu" ? "Saiu" : "Ficou" })
    ] }, item.id)) }),
    aAdicionar ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          autoFocus: true,
      ...
      /* @__PURE__ */ jsx("button", { onClick: adicionar, className: "px-3 py-1.5 rounded-md text-sm bg-cyan-500/15 text-cyan-300 hover:bg-cyan-500/25", children: "Guardar" }),
      /* @__PURE__ */ jsx("button", { onClick: () => setAAdicionar(false), className: "px-2 py-1.5 rounded-md text-sm text-zinc-500 hover:text-zinc-300", children: "✕" })
    ] }) : /* @__PURE__ */ jsxs(
      "button",
      {
