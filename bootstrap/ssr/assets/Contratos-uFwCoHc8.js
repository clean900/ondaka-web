...
import "remark-gfm";
import "driver.js";
function Contratos({ titulo, descricao }) {
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: titulo }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto py-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
        /* @__PURE__ */ jsx("div", { className: "p-2 rounded-lg bg-cyan-500/10", children: /* @__PURE__ */ jsx(FileSignature, { className: "w-6 h-6 text-cyan-400" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-zinc-700/50 bg-zinc-900/50 p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-400 max-w-md mx-auto", children: "Esta secção vai permitir gerir contratos do condomínio (administração, serviços, fornecedores) com versionamento e assinatura digital." })
      ] })
    ] })
  ] });
}
export {
  Contratos as default
};
