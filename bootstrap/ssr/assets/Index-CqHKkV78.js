...
import { Search, Sparkles, Clock, CheckCircle2, DollarSign, Building2, Home, Users, Smartphone, DoorOpen, Bot, Plug, ShieldCheck, Briefcase } from "lucide-react";
const categorias = [
  {
    id: "facturacao",
  ...
  const filtradas = useMemo(() => {
    return categoriasPublicas.map((cat) => ({
      ...
      features: cat.features.filter((f) => {
        return busca === "" || f.nome.toLowerCase().includes(busca.toLowerCase()) || f.desc.toLowerCase().includes(busca.toLowerCase());
      })
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0a0a1a] text-zinc-100", style: { fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }, children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-b border-blue-900/30 py-16", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-7xl px-6 text-center", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "mb-8 mx-auto max-w-2xl text-zinc-400", children: [
            "Tudo o que a plataforma ONDAKA oferece — ",
            /* @__PURE__ */ jsx("span", { className: "text-green-300 font-semibold", children: "já em produção" }),
            "."
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-md grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-green-500/30 bg-green-500/5 p-4", children: [
              /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-green-300", children: stats.total }),
              /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-green-400", children: "Funcionalidades em produção" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-zinc-800 bg-zinc-900/50 p-4", children: [
              /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold", children: stats.categorias }),
              /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-zinc-500", children: "Categorias" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "sticky top-[57px] z-40 border-b border-zinc-800 bg-[#0a0a1a]/95 backdrop-blur-md", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3 md:flex-row md:items-center md:justify-between", children: /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
