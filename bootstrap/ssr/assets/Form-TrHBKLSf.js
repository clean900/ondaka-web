...
import { A as AuthenticatedLayout, c as cn } from "./AuthenticatedLayout-vuYqEFtM.js";
...
function Form({ condomino, fraccaoId, fraccoes, proprietarios }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Associar imóvel" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submeter, className: "space-y-5", children: [
        ...
        /* @__PURE__ */ jsxs(Seccao, { icon: Home, iconColor: "#00D4FF", titulo: "Imóvel", children: [
          /* @__PURE__ */ jsx(Campo, { label: "Seleccione o imóvel", erro: errors.fraccao_id, obrigatorio: true, children: /* @__PURE__ */ jsxs(
            "select",
            {
