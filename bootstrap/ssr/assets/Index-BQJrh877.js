...
function Landing({ pricing, condominios = [], totais = { condominios: 0, condominos: 0 } }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0a0a1a] text-zinc-100", style: { fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }, children: [
      ...
      condominios.length > 0 && /* @__PURE__ */ jsx("section", { id: "condominios", className: "border-b border-zinc-800 py-20", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-12 text-center", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-zinc-100 sm:text-4xl", children: "Condomínios que confiam no ONDAKA" }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 text-zinc-400", children: "A nossa comunidade cresce todos os dias." }),
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex justify-center gap-12", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-4xl font-bold text-transparent", children: totais.condominios }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-zinc-400", children: "Condomínios" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-4xl font-bold text-transparent", children: totais.condominos }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-zinc-400", children: "Condóminos" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: condominios.map((c, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-zinc-800 bg-zinc-900/40 p-5", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-zinc-100", children: c.nome }),
          c.municipio && /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm text-zinc-500", children: [
            c.municipio,
            c.provincia ? `, ${c.provincia}` : ""
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "mt-3 text-sm text-zinc-400", children: [
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-zinc-200", children: c.num_condominos }),
            " ",
            c.num_condominos === 1 ? "condómino" : "condóminos"
          ] })
        ] }, i)) })
      ] }) }),
      ...
      /* @__PURE__ */ jsx("footer", { className: "border-t border-blue-900/30 py-10", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-between gap-4 text-sm text-zinc-500 md:flex-row", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-6 text-xs", children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: "/privacidade", className: "hover:text-white", children: "Privacidade" }),
          /* @__PURE__ */ jsx(Link, { href: "/termos", className: "hover:text-white", children: "Termos" })
        ] })
      ] }) }) })
    ] })
  ] });
