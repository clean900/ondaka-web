...
import { Receipt, Plus, Filter, CheckCircle, DollarSign, Edit, Ban, Trash2, X, Check } from "lucide-react";
import "sonner";
import "clsx";
          ...
          despesas.data.map((d) => {
            ...
            return /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5 hover:bg-white/[0.02]", children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-1", children: [
                ...
                (d.estado === "pendente" || d.estado === "aprovada") && /* @__PURE__ */ jsx("button", { onClick: () => setConfirmandoPaga(d), title: "Marcar paga", className: "p-1.5 rounded text-green-300 hover:bg-green-500/10", children: /* @__PURE__ */ jsx(DollarSign, { className: "h-4 w-4" }) }),
