...
import { Clock, Receipt, CheckCircle2, TrendingUp, Search, Filter, User, Building2, Calendar, Paperclip } from "lucide-react";
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs text-zinc-400 flex-wrap", children: [
                    ...
                    p.comprovativo_path && /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-cyan-400", title: "Comprovativo anexado", children: [
