...
import { DollarSign, Building2, Home, Users, Smartphone, DoorOpen, Bot, Plug, ShieldCheck, Briefcase, Search, Filter, Sparkles, Clock, CheckCircle2 } from "lucide-react";
const categorias = [
  {
    id: "facturacao",
  ...
  },
  {
    ...
    features: [
      ...
      { nome: "SMS Angola via serviço SMS ONDAKA", desc: "Para 2FA e alertas críticos.", estado: "pronto" }
    ]
  },
  {
    id: "mobile",
    ...
    features: [
      { nome: "Login com 2FA SMS", desc: "Autenticação segura via serviço SMS ONDAKA.", estado: "pronto" },
  ...
  },
  {
    ...
    features: [
      ...
      { nome: "Serviço SMS ONDAKA", desc: "SMS para 2FA e notificações críticas.", estado: "pronto" },
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0a0a1a] text-zinc-100", style: { fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }, children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-b border-blue-900/30 py-16", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-7xl px-6 text-center", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mb-8 mx-auto max-w-2xl text-zinc-400", children: "Tudo o que a plataforma ONDAKA oferece. Em produção, em desenvolvimento, em breve e no roadmap." }),
          /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-4xl grid-cols-2 gap-4 md:grid-cols-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-4", children: [
              /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-yellow-300", children: stats.curso }),
              /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-yellow-400", children: "Em curso" })
            ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-purple-500/30 bg-purple-500/5 p-4", children: [
              /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-300", children: stats.roadmap }),
              /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wider text-purple-400", children: "Roadmap" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "sticky top-[57px] z-40 border-b border-zinc-800 bg-[#0a0a1a]/95 backdrop-blur-md", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 md:flex-row md:items-center md:justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 overflow-x-auto", children: [
          ...
          ["todos", "pronto", "curso", "breve", "roadmap"].map((e) => /* @__PURE__ */ jsx(
            "button",
            {
