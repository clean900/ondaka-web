...
function Landing({ pricing }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0a0a1a] text-zinc-100", style: { fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "border-t border-blue-900/30 py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-6 text-center", children: [
        /* @__PURE__ */ jsxs("h2", { className: "mb-3 text-2xl font-bold md:text-3xl", children: [
          "Descarregue a ",
          /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent", children: "app móvel" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mb-8 text-zinc-400", children: "Condóminos, guardas e prestadores: leve o ONDAKA no bolso." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", className: "h-7 w-7", fill: "#fff", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M22.018 13.298l-3.919 2.218-3.515-3.493 3.543-3.521 3.891 2.202a1.49 1.49 0 0 1 0 2.594zM1.337.924a1.486 1.486 0 0 0-.112.568v21.017c0 .217.045.419.124.6l11.155-11.087L1.337.924zm12.207 10.065l3.258-3.238L3.45.195a1.466 1.466 0 0 0-.946-.179l11.04 10.973zm0 2.067l-11 10.933c.298.036.612-.016.906-.183l13.324-7.54-3.23-3.21z" }) }),
                /* @__PURE__ */ jsxs("div", { className: "text-left leading-tight", children: [
                  /* @__PURE__ */ jsx("div", { className: "text-[10px] uppercase tracking-wide text-zinc-400", children: "Disponível no" }),
