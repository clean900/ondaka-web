  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submeter, className: "space-y-5", children: [
        ...
        /* @__PURE__ */ jsx(Seccao, { icon: Ruler, iconColor: "#00D4FF", titulo: "Área e quota proporcional", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsx(Campo, { label: "Quota proporcional (‰)", erro: errors.permilagem, obrigatorio: true, ajuda: "Percentagem em milésimas do edifício", children: /* @__PURE__ */ jsx(
            "input",
            {
              type: "number",
              step: "0.0001",
        ...
        /* @__PURE__ */ jsxs(Seccao, { icon: DollarSign, iconColor: "#A855F7", titulo: "Taxas de Condomínio mensais (Kz)", children: [
