...
import { Sparkles, Building2, Calendar, Receipt, CheckCircle, CreditCard, Clock, AlertCircle, CalendarClock, RefreshCw, AlertTriangle, RotateCcw, XCircle, TrendingUp, TrendingDown } from "lucide-react";
import "sonner";
import "clsx";
          ...
          /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl px-4 sm:px-6 lg:px-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6", children: [
                ...
                calculo && !(subscricao == null ? void 0 : subscricao.activa) && /* @__PURE__ */ jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      ...
                      (subscricao == null ? void 0 : subscricao.em_trial) ? "Confirmar e activar subscrição" : `Iniciar trial de ${config.trial_duracao_dias} dias`
                    ]
                  }
                ),
