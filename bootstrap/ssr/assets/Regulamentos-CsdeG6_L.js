...
import "remark-gfm";
import "driver.js";
function Regulamentos({ titulo, descricao }) {
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: titulo }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto py-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
        /* @__PURE__ */ jsx("div", { className: "p-2 rounded-lg bg-purple-500/10", children: /* @__PURE__ */ jsx(ScrollText, { className: "w-6 h-6 text-purple-400" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-zinc-700/50 bg-zinc-900/50 p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-400 max-w-md mx-auto", children: "Esta secção vai disponibilizar o regulamento interno do condomínio e normas específicas (ruído, áreas comuns, animais, obras)." })
      ] })
    ] })
  ] });
}
export {
  Regulamentos as default
};
