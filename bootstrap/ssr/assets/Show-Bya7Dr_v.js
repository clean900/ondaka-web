...
function Show({ edificio, estatisticas }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3 mb-8", children: [
      ...
      /* @__PURE__ */ jsx(StatBox, { label: "Imóveis", valor: estatisticas.total_fraccoes, icon: Hash, cor: "#00D4FF" }),
      /* @__PURE__ */ jsx(
        StatBox,
        {
          label: "Área total",
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-white", children: "Imóveis" }),
