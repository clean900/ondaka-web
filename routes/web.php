...
Route::middleware(['auth', 'verified', '2fa'])->group(function () {
    ...
    Route::middleware('role:super-admin|admin-empresa|gestor|administrador-condominio')
        ...
        ->group(function () {
            ...
            Route::get('/atribuiveis', [TicketsWebController::class, 'atribuiveis'])->name('atribuiveis');
    ...
    Route::middleware('role:admin-empresa|gestor|administrador-condominio')
        ...
        ->group(function () {
            ...
            Route::post('/reservar-fundo', [ContaBancariaController::class, 'reservarFundo'])->name('reservar-fundo');
        });
    ...
    Route::middleware('role:super-admin|admin-empresa|gestor|administrador-condominio')
        ...
        ->group(function () {
            ...
            Route::get('/{id}/ver-comprovativo', [\App\Domains\Facturacao\Http\Controllers\Web\PagamentosWebController::class, 'comprovativo'])->whereNumber('id')->name('ver-comprovativo');
